...
- Per-video outputs live in [`workproducts/<video>/`](workproducts/) — **gitignored**
  (derived from copyrighted video) and mirrored to a private GCS bucket; only each
  video's `SOURCE.md` manifest is tracked.
